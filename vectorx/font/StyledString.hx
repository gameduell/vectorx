...
class StyledString
{
    ...
    {
        return parser.toAttributedString(styledString, fontAliases, fontCache, null, colors);
    }

    public static function toAttributedString(styledString: String, context: StyledStringContext): AttributedString
    {
        return parser.toAttributedString(styledString, context.fontAliases, context.fontCache, context.fontAttachments, context.colors);
    }
}
